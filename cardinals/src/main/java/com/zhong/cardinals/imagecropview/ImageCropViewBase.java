...
public abstract class ImageCropViewBase extends AppCompatImageView {
    ...
    private float gridOutDistance = 0;
    ...
    protected void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        gridOutDistance = a.getDimension(R.styleable.ImageCropView_gridOutDistance, 0);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        int height = (int) ((mThisWidth - 2 * gridOutDistance) * mTargetAspectRatio);
        if (height > mThisHeight) {
            ...
            mCropRect.set(left + gridOutDistance, halfDiff - top, right - gridOutDistance, height + halfDiff);
        }
    ...
    private void drawTransparentLayer(Canvas canvas) {
        ...
        canvas.drawRect(r.left, mCropRect.bottom, mCropRect.right + gridOutDistance, r.bottom, mTransparentLayerPaint);         // bottom
    ...
    public void setImageFilePath(final String imageFilePath, View loadingView) {
        ...
        final int reqSize = 1000;
        if (loadingView != null) loadingView.setVisibility(VISIBLE);
        new Thread(new Runnable() {
            @Override
            public void run() {
                Bitmap bitmap = BitmapLoadUtils.decode(ImageCropViewBase.this.imageFilePath, reqSize, reqSize, true);
